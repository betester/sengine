...
def sort_intersect_list(list_A, list_B):
    ...
    while i < len(list_A) and j < len(list_B):
        if list_A[i] == list_B[j]:
            intersection_result.append(list_A[i])
            i += 1
            j += 1
